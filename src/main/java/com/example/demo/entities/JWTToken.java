...
public class JWTToken {
	...
	@Id
	@GeneratedValue(strategy = GenerationType. IDENTITY) // Specifies that the tokenld will be auto-generated.
	...
	public Integer getTokenld() {
		return tokenId;
	}
	public void setTokenld(Integer tokenld) {
		this.tokenId = tokenld;
	}
	public User getUser() {
		return user;
	}
